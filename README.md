...
### [NFI Engine](https://github.com/vntrevx/NFI_Engine)
A clean-room, local-first crypto trading engine for deterministic backtesting, paper runs, testnet operations, and safety-first exchange workflows.
